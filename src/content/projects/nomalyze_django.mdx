...
<details className='project__details'>
  <summary><span className='open'>Read full case study</span><span className='close'>Collapse full case study</span></summary>

<div className='project--big__info'>
<div className='project--big__info_detail'>
## The Challenge
